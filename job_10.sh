...
python train_stage2.py --cfg ./config/cifar10/cifar10_imb01_stage2_mislas.yaml resume /scratch/sz65/cc0395/MiSLAS/saved/cifar10_imb01_stage1_mixup/ckps/model_best.pth.tar
